...
- **Current sub-phase:** **M7 — Ask OBSIDIAN. ✅ COMPLETE and VERIFIED (static checks + owner tested live with the API key, 2026-07-21).**
...
M7 is complete and owner-verified live (Ask OBSIDIAN answers from tools; unsupported questions decline). `getInactiveCustomers` was intentionally deferred to M9 (customer intelligence), where inactive-customer detection lives.
